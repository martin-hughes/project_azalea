...
class system_tree_simple_branch : public virtual ISystemTreeBranch
{
public:
...
protected:
  ...
  std::map<std::string, std::shared_ptr<IHandledObject>> children;
  ...
  virtual ERR_CODE create_child_here(std::shared_ptr<IHandledObject> &child);
  ...
  ipc::raw_spinlock child_tree_lock;
};
