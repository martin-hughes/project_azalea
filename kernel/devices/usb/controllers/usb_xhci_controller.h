...
namespace usb { namespace xhci
{
  ...
  ///
  class command_response : public WaitForFirstTriggerObject
  {
  public:
    command_completion_event_trb trb; ///< The command completion event TRB generated by an earlier command.

    /// @brief Call this when the associated command has been completed
    virtual void response_complete() { this->trigger_all_threads(); };
  };
