// Memory test script 2.
//
// Contains two tests that fuzz the allocator by randomly allocating and deallocating blocks of RAM. One does this
...
TEST(MemoryKMalloc, MultiThreadFuzzTest)
{
